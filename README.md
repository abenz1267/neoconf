...
1. `install <plugin1> <plugin2> ...`: installs or updates all plugins provided. Also install missing plugins from "plugins.json". Creates plugin configuration-file under `lua/plugins`
